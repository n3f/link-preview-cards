...
describe('View Script CSS Selector Issue', () => {
    test('should identify the correct CSS selector for the block', () => {
        // The block name in block.json is: open-graph-card/og-card
        // This should generate CSS class: wp-block-open-graph-card-og-card
        const blockName = 'open-graph-card/og-card';
        const expectedCssClass = 'wp-block-open-graph-card-og-card';
    ...
    test('should identify the incorrect selector currently used in view.js', () => {
        ...
        const correctSelector = '.wp-block-open-graph-card-og-card';
    ...
    test('should verify the block name matches what WordPress expects', () => {
        ...
        expect(blockJson.name).toBe('open-graph-card/og-card');
    });
