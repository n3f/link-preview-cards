<?php
/**
 * Test cases for Link Preview Cards API endpoint
 */
...
function linkpreviewcards_test_og_extraction() {
    $html = '
        <html>
            <head>
...
function linkpreviewcards_test_og_extraction_with_quotes() {
    $html = '
        <html>
            <head>
...
function linkpreviewcards_test_og_extraction_case_insensitive() {
    $html = '
        <html>
            <head>
...
function linkpreviewcards_test_og_extraction_no_tags() {
    $html = '
        <html>
            <head>
...
linkpreviewcards_test_og_extraction();
linkpreviewcards_test_og_extraction_with_quotes();
linkpreviewcards_test_og_extraction_case_insensitive();
linkpreviewcards_test_og_extraction_no_tags();
function linkpreviewcards_test_og_extraction_with_special_characters() {
    $html = '
        <html>
            <head>
...
function linkpreviewcards_test_og_extraction_malformed_html() {
    $html = '
        <html>
            <head>
                <meta property="og:title" content="Test Title">
...
linkpreviewcards_test_og_extraction_case_insensitive();
linkpreviewcards_test_og_extraction_no_tags();
linkpreviewcards_test_og_extraction_with_special_characters();
linkpreviewcards_test_og_extraction_malformed_html();
